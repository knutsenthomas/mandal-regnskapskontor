...
const ContactForm = () => {
  ...
  const { content: sectionLabel } = useContent('contact.sectionlabel');
  const { content: title } = useContent('contact.title');
  const { content: subtitle } = useContent('contact.subtitle');
  const { content: phone } = useContent('contact.phone');
  const { content: email } = useContent('contact.email');
  const { content: address } = useContent('contact.address');
  const { content: phoneLabel } = useContent('contact.phoneLabel');
  const { content: emailLabel } = useContent('contact.emailLabel');
  const { content: addressLabel } = useContent('contact.addressLabel');
  const { content: formName } = useContent('contact.form.name');
  const { content: formPhone } = useContent('contact.form.phone');
  const { content: formEmail } = useContent('contact.form.email');
